...
if y_stereo is not None:
    ...
    plt.tight_layout()
    plt.savefig("outputs/task2_1_waveform_stereo_left.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig("outputs/task2_1_waveform_stereo_right.png")
    plt.close()
...
plt.tight_layout()
plt.savefig("outputs/task2_1_waveform_mono.png")
plt.close()
